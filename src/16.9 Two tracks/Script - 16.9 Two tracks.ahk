...
while i < count
{
	...
	FileAppend,
	(
	"C:\Program Files (x86)\MKVToolNix\mkvmerge.exe" -o "%folder%\Muxed\%filename%.mkv"  "--language" "0:eng" "--default-track" "0:yes" "--forced-track" "0:no" "--aspect-ratio" "0:16/9" "--language" "1:eng" "--default-track" "1:yes" "--forced-track" "1:no" "--language" "2:fre" "--default-track" "2:no" "--forced-track" "2:no" "-a" "1,2" "-d" "0" "-S" "-T" "--no-global-tags" "(" "%folder%\%filename%.mkv" ")" "--sub-charset" "0:UTF-8" "--language" "0:fre" "--track-name" "0:Sous-titres" "--default-track" "0:yes" "--forced-track" "0:no" "-s" "0" "-D" "-A" "-T" "--no-global-tags" "--no-chapters" "(" "%folder%\%filename%.srt" ")" "--track-order" "0:0,0:1,0:2,1:0"
	), %folder%\mux.bat
